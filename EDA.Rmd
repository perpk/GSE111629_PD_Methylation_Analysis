...
save_rds(methyl_set, "methyl_set_s_mismatch.rds")
save_rds(rg_set, "rg_set_s_mismatch.rds")
save_rds(beta_matrix, "beta_matrix_s_mismatch.rds")
save_rds(m_values, "m_values_s_mismatch.rds")
```